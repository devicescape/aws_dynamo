...
struct aws_dynamo_batch_write_item_response *aws_dynamo_batch_write_item(struct aws_handle
							       *aws, const char
							       *request)
{
	const char *response;
...
void aws_dynamo_dump_batch_write_item_response(struct aws_dynamo_batch_write_item_response
					  *r)
{
#ifdef DEBUG_PARSER
	int i;
